...
CONFIG_TARGET_ath79_generic_DEVICE_glinet_gl-mifi=y
...
# Image path : openwrt/bin/targets/ath79/generic/openwrt-ath79-generic-glinet_gl-mifi-squashfs-sysupgrade.bin
```
